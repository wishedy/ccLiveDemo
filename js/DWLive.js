/*
* create By ZhangHeng on 2018/1/18
*/
/**
 * CC live video
 * v2.2.2 2017/12/26
...
(function () {
    var DWLive = {
        init: function (option) {
            ...
            this.viewername = option.viewername;
            this.viewertoken = option.viewertoken;
            this.forcibly = option.forcibly;
            this.viewercustomua = option.viewercustomua;
        ...
        login: function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var host = data.datas.pusher.chatHost;
